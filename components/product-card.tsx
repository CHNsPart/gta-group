  ...
  <div className="w-full p-4 md:w-1/2 lg:w-1/4">
    <a href={`/categories/${product.category}/${product.subCategory}/${product.sku}`} className="relative block h-56 overflow-hidden rounded hover:cursor-pointer">
      <Image
        quality={100}
        alt={product.title}
        className={product.subCategory==="ballcaps" || "winterhats" ? `block size-full object-cover object-center transition-all hover:scale-105` : `block size-full object-cover object-top transition-all hover:scale-105`}
        src={product.image}
      />
    </a>
    <div className="mt-4">
